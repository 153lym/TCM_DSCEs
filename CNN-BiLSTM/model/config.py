...
class Config():
    def __init__(self, parser, load=True):
        ...
        parser.add_argument('--dir_output', default='', type=str,
                    help='directory for output')
        parser.add_argument('--data_root', default='/data', type=str,help='directory for output')
        #parser.add_argument('--data_root', default='/home/lym/project/bilstm/bilstm_att_bilstm_crf/data/folds/split_0', type=str,help='directory for output')
        parser.add_argument('--filename_wordvec_trimmed', default='/bert_merge.txt',
        ...
        # dataset
        self.filename_dev = os.path.join(self.data_root, 'dev.txt')
        self.filename_test = os.path.join(self.data_root, 'test.txt')
        self.filename_train = os.path.join(self.data_root, 'train.txt')
        ...
        #if not os.path.exists('/home/lym/data'):
         #   os.makedirs('/home/lym/data')
    ...
    def load(self):
        ...
        # 3. get pre-trained embeddings  use_pretrained=true
